...
export const GOOGLE_CONFIG = {
  ...
  SCRIPT_API_URL: 'https://script.google.com/macros/s/AKfycbx5x6lfKiu8fS8Qq_hYzNfBEAi4der-jEbhjKF_SqtD7pWQuKlAVQjNYWiOqdkc2c82/exec',
...
export const MOCK_REPORTS: Report[] = [
  {
    ...
    date: 'Feb 2026',
    category: 'Estrategia',
    summary: 'Actualización institucional sobre la transición hacia un portafolio global.',
    sections: [
      { titulo: '1. Introducción', content: 'Fortalecimiento del modelo operativo.' }
    ]
  }
];
